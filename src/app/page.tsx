...
export default function CardHome() {
  ...
  const [searchedConvertedManaCost, setSearchedConvertedManaCost] =
    useState("");
  const [searchedFormat, setSearchedFormat] = useState("");
  const [searchedCommanderColors, setSearchedCommanderColors] = useState<
    string[]
  >([]);
  ...
  const handleCommanderColorChange = (
    colorValue: string,
    isChecked: boolean
  ) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setCurrentPage(1);
    setCardResults(
      await Scry.Cards.search(lastQuery, currentPage)
        .cancelAfterPage()
        .waitForAll()
    );
  };
    ...
    <>
      <div className={"min-h-[85vh]"}>
        ...
        <div className={"flex sm:flex-row flex-col"}>
          ...
          <form
            className="sidebar bg-primary/30 p-8 sm:min-w-[325px] sm:max-w-1/5 w-full flex flex-col space-y-6"
          ...
          >
            ...
            <div className="input-group space-y-2">
              ...
              <Input
                id="cardName"
                placeholder="ex. Rhystic Study"
                type="text"
                value={searchedCardName}
                onChange={(e) => setSearchedCardName(e.target.value)}
              />
            </div>
            ...
            <div className="input-group space-y-2">
              ...
              <Input
                id="typeLine"
                placeholder="ex. 'Creature' or 'Human Wizard'"
                type="text"
                value={searchedTypeLine}
                onChange={(e) => setSearchedTypeLine(e.target.value)}
              />
            </div>
            ...
            <div className="input-group space-y-2">
              ...
              <div className="input-group space-y-2 mt-4">
                ...
                <Select
                  name="colorsMatchType"
                  value={searchedColorsMatchType}
                  onValueChange={setSearchedColorsMatchType}
                >
            ...
            <div className="input-group space-y-2">
              <Label htmlFor="converted-manaCost">
                Converted Mana Cost (CMC)
              </Label>
              <Input
                id="converted-manaCost"
                min="0"
                placeholder="ex. 3, 5"
                type="text"
                value={searchedConvertedManaCost}
                onChange={(e) => setSearchedConvertedManaCost(e.target.value)}
              />
            </div>
            ...
            <div className="input-group space-y-2">
              ...
              <Select onValueChange={setSearchedFormat} value={searchedFormat}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="pauper_commander">
                    Pauper Commander
                  </SelectItem>
                  ...
                  {["W", "U", "B", "R", "G", "C"].map((color) => (
                    ...
                    >
                      <Checkbox
                        ...
                        name="commander[]"
                        value={color}
                        checked={searchedCommanderColors.includes(color)}
                        onCheckedChange={(checked) =>
                          handleCommanderColorChange(color, checked as boolean)
                        }
                      />
            ...
            <div className="input-group space-y-2">
              ...
              <Input
                id="setName"
                placeholder="ex. MAR, DFT"
                type="text"
                value={searchedSetName}
                onChange={(e) => setSearchedSetName(e.target.value)}
              />
            </div>
